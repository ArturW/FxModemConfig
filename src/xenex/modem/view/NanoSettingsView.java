 ...
 * @author user
 */
public class NanoSettingsView extends VBox {
    ...
    final Spinner<Integer> linkRateSpinner = new Spinner<>(0, 3, 2);
    ...
    private void setupView() {
        ...
        radioGrid.add(encryptionKeyText, 0, 2);
        radioGrid.add(encryptionModeText, 0, 3);
        
        radioGrid.add(linkRate, 1, 0);
        radioGrid.add(power, 1, 1);
        radioGrid.add(encryptionKey, 1, 2);
        radioGrid.add(encryptionMode, 1, 3);
        
        radioGrid.add(linkRateCheckBox, 2, 0);
        radioGrid.add(powerCheckBox, 2, 1);
        radioGrid.add(encryptionKeyCheckBox, 2, 2);
        radioGrid.add(encryptionModeCheckBox, 2, 3);
        
        radioGrid.add(linkRateSpinner, 3, 0);
        radioGrid.add(powerSpinner, 3, 1);        
        radioGrid.add(encryptionKeySpinner, 3, 2);
        radioGrid.add(encryptionModeSpinner, 3, 3);
