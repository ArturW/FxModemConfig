 ...
 * @author user
 */
class NanoDeviceView extends VBox {

    Text serialNumber = new Text("");
    ...
    private void setupView() {
        ...
        Text serialNumberText = new Text("Serial Number: ");
