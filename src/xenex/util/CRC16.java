 ...
 *  its 16-bit Cyclic Redundancy Check (CRC16). Uses a lookup TABLE16.
...
public class CRC16 {
    ...
    public static int getModbusValue(byte[] bytes) {                
        int crc = 0xFFFF;
        for (byte b : bytes) {
            crc = (crc >>> 8) ^ TABLE16[(crc ^ b) & 0xff];
        }        
    ...
    public static void main(String[] args) { 
        ...
        System.out.println(CRC16.getValue(data));        
        System.out.println(Integer.toHexString(CRC16.getValue(data)));
        System.out.println(Integer.toHexString(CRC16.getModbusValue(data)));
